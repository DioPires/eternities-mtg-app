/**
 * Phase 2a's app: the star field, the effects, the bench harness, and the Phase 0 contract panel.
 *
 ...
 * in Phase 0; this exists so the field can be looked at and benched before that lands, and Phase
 * 2b replaces it. Likewise the panel below is Phase 0's contract self-test with the scene's own
 * progress added — not PRD section 6's HUD, which is Phase 4's.
 */
