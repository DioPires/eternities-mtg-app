...
describe("the negative-control matrix", () => {
  ...
  it("has eight expected-RED rows, nine expected-GREEN and five expected-N/A", () => {
    // Eight and seven until DEC-882: `layers-128-reduced` was the eighth RED and is now GREEN. See
    // the absolute-term row below for what that costs. DEC-861 added one of each: the one-card
    // row's pixel witness and the draw-blank control that falsifies it.
